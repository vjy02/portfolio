export default function BlogPostPillLoading() {
  return (
    <div className="w-full md:10/12 cursor-pointer flex animate-pulse">
      ...
      <div className="ml-2 md:ml-auto h-4 bg-gray-200 dark:bg-slate-700 rounded-md w-12 md:w-16" />
    </div>
  );
}
